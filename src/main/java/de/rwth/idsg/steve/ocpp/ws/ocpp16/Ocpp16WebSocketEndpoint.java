...
public class Ocpp16WebSocketEndpoint extends AbstractWebSocketEndpoint {
    ...
    public Ocpp16WebSocketEndpoint(OcppServerRepository ocppServerRepository,
        ...
        super(ocppServerRepository, futureResponseContextStore, applicationEventPublisher, sessionContextStoreHolder, Ocpp16TypeStore.INSTANCE, chargePointMessageService);
        this.server = server;
    }
