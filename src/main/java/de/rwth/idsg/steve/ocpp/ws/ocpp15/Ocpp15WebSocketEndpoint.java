...
public class Ocpp15WebSocketEndpoint extends AbstractWebSocketEndpoint {
    ...
    public Ocpp15WebSocketEndpoint(OcppServerRepository ocppServerRepository,
        ...
        super(ocppServerRepository, futureResponseContextStore, applicationEventPublisher, sessionContextStoreHolder, Ocpp15TypeStore.INSTANCE, chargePointMessageService);
        this.server = server;
    }
